...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/work-totes" component={CategoryPage} />
      <Route path="/travel-totes" component={CategoryPage} />
      <Route path="/everyday-carry" component={CategoryPage} />
      <Route path="/leather-care-tips" component={CategoryPage} />
      <Route path="/budget-friendly-picks" component={CategoryPage} />
