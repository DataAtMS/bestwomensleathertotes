...
export default function Contact() {
  ...
  useEffect(() => {
    document.title = 'Contact | Best Leather Totes';
    ...
    const desc = 'Get in touch with the Best Leather Totes team. We read every message.';
    setMeta('meta[name="description"]', 'description', desc, 'name');
    setMeta('meta[property="og:title"]', 'og:title', 'Contact | Best Leather Totes', 'property');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (contactEmail) {
      const subject = encodeURIComponent('Message from ' + name + ' via Best Leather Totes');
  ...
  return (
    <div style={{ minHeight: "100vh", background: COLOR.bg, color: COLOR.body }}>
      ...
      <main style={{ maxWidth: "600px", margin: "0 auto", padding: "clamp(40px, 8vw, 72px) clamp(24px, 6vw, 48px)" }}>
        ...
        <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "clamp(1.4rem, 3.5vw, 2rem)", fontWeight: 700, color: COLOR.primary, lineHeight: 1.2, marginBottom: "12px", letterSpacing: "-0.02em" }}>
          Get in Touch
        </h1>
        <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: "15px", color: COLOR.secondary, lineHeight: 1.7, marginBottom: "40px" }}>
          Have a question, a correction, or data from your own store you want to share? We read everything.
        </p>

        {submitted ? (
          <div style={{ background: "#f4f0e8", border: "1px solid #c4b89a", borderRadius: "4px", padding: "24px", textAlign: "center" }}>
            <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "11px", color: "#6b5a3e", letterSpacing: "0.08em", marginBottom: "8px" }}>
              ✓ MESSAGE SENT
            </div>
            <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: "14px", color: COLOR.secondary }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div>
              <label style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "10px", color: COLOR.tertiary, letterSpacing: "0.08em", display: "block", marginBottom: "8px" }}>
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                style={{ ...inputStyle, resize: "vertical", fontFamily: "'Lora', Georgia, serif" }}
                onFocus={(e) => (e.currentTarget.style.borderColor = COLOR.accent)}
                onBlur={(e) => (e.currentTarget.style.borderColor = "#ddd5c0")}
              />
            </div>
            ...
            <p style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "10px", color: COLOR.faint, marginTop: "-8px" }}>
              {contactEmail
      ...
      <footer style={{ borderTop: `1px solid ${COLOR.border}`, padding: "32px clamp(24px, 6vw, 48px)", maxWidth: "600px", margin: "0 auto" }}>
        <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
          ...
          <Link href="/about"><span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "10px", color: COLOR.tertiary, cursor: "pointer", letterSpacing: "0.04em" }} onMouseEnter={(e) => (e.currentTarget.style.color = COLOR.body)} onMouseLeave={(e) => (e.currentTarget.style.color = COLOR.tertiary)}>ABOUT</span></Link>
          <Link href="/contact"><span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "10px", color: COLOR.accent, cursor: "pointer", letterSpacing: "0.04em" }}>CONTACT</span></Link>
