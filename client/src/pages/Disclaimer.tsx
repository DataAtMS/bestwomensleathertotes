...
export default function Disclaimer() {
  ...
  useEffect(() => {
    document.title = 'Affiliate Disclaimer | Best Leather Totes';
    ...
    setMeta('meta[name="description"]', 'description', 'Affiliate and earnings disclaimer for Best Leather Totes.', 'name');
    setMeta('meta[property="og:title"]', 'og:title', 'Affiliate Disclaimer | Best Leather Totes', 'property');
  ...
  return (
    <div style={{ minHeight: "100vh", background: COLOR.bg, color: COLOR.body }}>
      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "clamp(40px, 8vw, 72px) clamp(24px, 6vw, 48px)" }}>
        ...
        <p style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "11px", color: COLOR.faint, marginBottom: "40px" }}>
          Last updated: April 24, 2026
        </p>

        {/* FTC-required prominent disclosure at the top */}
        <div style={{ background: "#f4f0e8", border: `1px solid ${COLOR.accent}33`, borderLeft: `3px solid ${COLOR.accent}`, borderRadius: "4px", padding: "20px 24px", marginBottom: "40px" }}>
          <p style={{ fontFamily: "'Lora', Georgia, serif", fontSize: "15px", color: "#3a2e1e", lineHeight: 1.7, margin: 0 }}>
            <strong style={{ color: "#1c1610" }}>Disclosure:</strong> Some links on Best Leather Totes are affiliate links. If you click one and make a purchase, we may earn a commission at no extra cost to you. We only recommend tools we have personally tested.
          </p>
        </div>
      ...
      <footer style={{ borderTop: `1px solid ${COLOR.border}`, padding: "32px clamp(24px, 6vw, 48px)", maxWidth: "720px", margin: "0 auto" }}>
        <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
          ...
          <Link href="/disclaimer"><span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "10px", color: COLOR.accent, cursor: "pointer", letterSpacing: "0.04em" }}>DISCLAIMER</span></Link>
        </div>
