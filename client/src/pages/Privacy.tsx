...
export default function Privacy() {
  ...
  useEffect(() => {
    document.title = 'Privacy Policy | Best Leather Totes';
    ...
    setMeta('meta[name="description"]', 'description', 'Privacy Policy for Best Leather Totes. How we collect, use, and protect your information.', 'name');
    setMeta('meta[property="og:title"]', 'og:title', 'Privacy Policy | Best Leather Totes', 'property');
    ...
    <div style={{ minHeight: "100vh", background: COLOR.bg, color: COLOR.body }}>
      ...
      <footer style={{ borderTop: `1px solid ${COLOR.border}`, padding: "32px clamp(24px, 6vw, 48px)", maxWidth: "720px", margin: "0 auto" }}>
        <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
          ...
          <Link href="/privacy"><span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "10px", color: COLOR.accent, cursor: "pointer", letterSpacing: "0.04em" }}>PRIVACY</span></Link>
